...
{
    public partial class popMapTransferManualCycleRun : BaseSubMenu
    {
        ...
        public popMapTransferManualCycleRun()
        {
            InitializeComponent();
            this.CenterToScreen();
        }
        ...
        private void OnMapTransferManualCycleButtonClick(object sender, EventArgs e)
        {
        ...
        void StartCycle(GlassButton btn, params object[] args)
        {
            ...
            GbSeq.manualRun.SetManualSorterCycleRun(nSeqNo, (rdbBlowTableNo.Checked ? 0 : 1), (rdbMapVisionTable.Checked ? 0 : 1), args);
