...
{
    public partial class popClrNDryManualCycleRun : BaseSubMenu
    {
        ...
        public popClrNDryManualCycleRun()
        {
            InitializeComponent();
            this.CenterToScreen();
        }
        ...
        private void CleanAndDryCycleStart_Click(object sender, EventArgs e)
        {
