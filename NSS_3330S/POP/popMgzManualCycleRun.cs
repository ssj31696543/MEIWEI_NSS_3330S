...
{
    public partial class popMgzManualCycleRun : BaseSubMenu
    {
        ...
        public popMgzManualCycleRun()
        {
            InitializeComponent();
            this.CenterToScreen();
        }

        private void OnLdMgzTransferCycleStartButtonClick(object sender, EventArgs e)
        {
        ...
        private void OnLdMgzLotStartCycleStartButtonClick(object sender, EventArgs e)
        {
            GlassButton btn = sender as GlassButton;
            GbFunc.WriteEventLog("Manual Cycle ", string.Format("{0} : BUTTON CLICK",
                btn.Text));
