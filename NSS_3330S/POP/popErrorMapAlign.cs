...
{
    public partial class popErrorMapAlign : Form
    {
        public int nErrNo = 0;
        ...
        private void tmrErr_Tick(object sender, EventArgs e)
        {
            ...
            switch (ConfigMgr.Inst.Cfg.General.nLanguage)
            {
                case (int)Language.CHINA:
                    {
                        if (btnRetryMapAlign.Text != "再检查") btnRetryMapAlign.Text = "再检查";
                ...
                case (int)Language.KOREAN:
                    {
                        if (btnRetryMapAlign.Text != "재검사") btnRetryMapAlign.Text = "재검사";
                ...
                case (int)Language.ENGLISH:
                    {
                        if (btnRetryMapAlign.Text != "RETRY") btnRetryMapAlign.Text = "RETRY";
        ...
        private void btnRetryMapAlign_Click(object sender, EventArgs e)
        {
            // 재검사
            GbVar.Seq.sMapTransfer.bRetryMapAlign = true;
        ...
        {
            // 강제 진행
            GbVar.Seq.sMapTransfer.bRetryMapAlign = false;
