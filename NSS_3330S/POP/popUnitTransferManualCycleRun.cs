...
{
    public partial class popUnitTransferManualCycleRun : BaseSubMenu
    {
        ...
        public popUnitTransferManualCycleRun()
        {
            InitializeComponent();
            this.CenterToScreen();
        }
        ...
        private void OnUnitTransferManualCycleButtonClick(object sender, EventArgs e)
        {
        ...
        void StartCycle(GlassButton btn, params object[] args)
        {
            ...
            GbSeq.manualRun.SetManualSawCycleRun(nSeqNo, (rdbTableNo.Checked ? 0 : 1), args);
