...
namespace NSS_3330S
{
    public class DBExFromSorter: DBExBase
    {
        bool isOpen;

        public DBExFromSorter()
        {
            TABLE_NAME = "FROM_SORTER";
        ...
        /// <returns></returns>
        public string SelectResultY(int nRow = 1, string strAddOption = "")
        {
            ...
            if (helper.CONNECTION.State == ConnectionState.Open)
            {
                ...
                values = dr.ItemArray[3].ToString();
