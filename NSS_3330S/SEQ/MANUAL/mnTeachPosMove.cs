...
namespace NSS_3330S.SEQ.MANUAL
{
    ...
    public class mnTeachPosMove : SeqBase
    {
        ...
        public void SetParam_ChipPickerMove(int _nHeadNo, int _nPickerNo, int _nPickerColCount, int _nTableNo, int _nTableCount)
        {
            ...
            MoveType = MoveType.ChipPickCamMove;
        }
        public void SetParam_ChipPickMove(int _nHeadNo, int _nPickerNo, int _nPickerColCount, int _nTableNo, int _nTableCount)
        {
            nHeadNo = _nHeadNo;
            nPickerNo = _nPickerNo;
            nPickerColCount = _nPickerColCount;
            nTableNo = _nTableNo;
            nTableCount = _nTableCount;
            MoveType = MoveType.ChipPickMove;
        }
        public void SetParam_ChipGoodPlaceMove(int _nHeadNo, int _nPickerNo, int _nTableNo, int _nTableCount)
        {
            ...
            nTableNo = _nTableNo;
            nTableCount = _nTableCount;
            MoveType = MoveType.ChipGoodPlaceMove;
        }
        public void SetParam_ChipRejectMove(int _nHeadNo, int _nPickerNo,  int _nTableCount)
        {
            nHeadNo = _nHeadNo;
            nPickerNo = _nPickerNo;         
            nTableCount = _nTableCount;
            MoveType = MoveType.ChipRejectPlaceMove;
        }
        public override void Run()
        {
            ...
            switch (m_nSeqNo)
            {
                ...
                case 1:
                    if (MoveType == MoveType.Default)
                    {
                        nFuncResult = ManualInterLockCheck(m_nAxisArray);
                        if (FNC.IsErr(nFuncResult))
                        {
                            SetError(nFuncResult);
                            return;
                ...
                case 2:
                    ...
                    else if (MoveType == MoveType.ChipPickCamMove)
                        nFuncResult = MovePosChipPickUpXYCam(nHeadNo, true, nPickerNo, nPickerColCount, nTableNo, nTableCount);
                    else if (MoveType == MoveType.ChipPickMove)
                        nFuncResult = MovePosChipPickUpXYNEW(nHeadNo, true, nPickerNo, nPickerColCount, nTableNo, nTableCount);
                    else if (MoveType == MoveType.ChipGoodPlaceMove)
                        nFuncResult = MovePosChipPlaceToGoodXY_NEW(nHeadNo, true, nPickerNo, nTableNo, nTableCount);
                    else if (MoveType == MoveType.ChipRejectPlaceMove)
                        nFuncResult = MovePosChipPlaceToReworkXY(nHeadNo, nPickerNo, nTableNo, nTableCount);
