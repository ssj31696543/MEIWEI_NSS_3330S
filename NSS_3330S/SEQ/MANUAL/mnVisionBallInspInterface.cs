...
{
    public class mnVisionBallInspInterface : SeqBase
    {
        int _nTableNo = 0;
        ...
        public mnVisionBallInspInterface()
        {
        ...
        public void SetParam(int nTableNo, int nMaxTriggerCount)
        {
            _nTableNo = nTableNo;
            _nMaxTriggerCount = nMaxTriggerCount;
        }
        ...
        public override void Run()
        {
            ...
            switch (m_nSeqNo)
            {
                ...
                case 2:
                    nFuncResult = _cycMapTransfer.ManualBallInspInterface(_nTableNo, _nMaxTriggerCount);
                    break;
