...
{
    public class mnVisionMapInspInterface : SeqBase
    {
        int _nTableNo = 0;
        ...
        public mnVisionMapInspInterface()
        {
        ...
        public override void Run()
        {
            ...
            switch (m_nSeqNo)
            {
                ...
                case 2:
                    nFuncResult = _cycMapTransfer.ManualMapInspInterface(_nTableNo, _nMaxTriggerCount);
                    break;
