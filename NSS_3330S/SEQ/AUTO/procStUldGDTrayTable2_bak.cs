                ...
                case 16:
                    {
                        ...
                        if (GbVar.Seq.sUldGDTrayTable[m_nTableNo].bSeqIfVar[seqUldGoodTrayTable.TRAY_UNIT_FULL] == true)
                        {
                            ...
                            {
                                SeqHistory("Tray Exist is False. Looading Start.");
                            }
                        }
                    }
                    break;
                ...
                case 26:
                    {
                        ...
                        string strCnt = string.Format("Current Lot Good Table Tray Work Count: {0}", GbVar.lstBinding_EqpProc[MCDF.CURRLOT].GOOD_TABLE_2_TRAY_WORK_COUNT);
                ...
                case 52:
                    {
                        ...
                        // Good 트레이 배출
                        else if (GbVar.Seq.bGoodTrayOut) //else if (GbVar.Seq.bGoodTrayOut[m_nTableNo]) sj.shin 2023-12-31 신아이 소스에서는 원복
                        {
                            // 소터에 자재가 없을 경우에만 배출
