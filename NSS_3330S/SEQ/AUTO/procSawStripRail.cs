...
{
    public class procSawStripRail : SeqBase
    {
        public procSawStripRail(int nSeqID)
        {
            m_nSeqID = nSeqID;
            m_seqInfo = GbVar.Seq.sStripRail;
        }
        ...
        public override void Run()
        {
            ...
            if (m_seqInfo != null)
            {
                if (m_seqInfo != GbVar.Seq.sStripRail)
                {
                    m_seqInfo = GbVar.Seq.sStripRail;
                    m_nSeqNo = GbVar.Seq.sStripRail.nCurrentSeqNo;
                }
            ...
            if (FNC.IsErr(nFuncResult))
            {
                GbVar.Seq.sStripRail.Info.bIsError = true;
                SetError(nFuncResult);
                return;
            }
